...
public class ImageRotation implements RequestHandler<HashMap<String, Object>, HashMap<String, Object>> {
    ...
    public HashMap<String, Object> handleRequest(HashMap<String, Object> request, Context context) {
        ...
        try {
            ...
            //inspector.addAttribute("rotated_image", rotatedImageBase64);
    ...
    public static void main(String[] args) {
        ...
        try (FileInputStream fileInputStreamReader = new FileInputStream(file)) {
            ...
            System.out.println(new ImageRotation().handleRequest(req, null).toString());
