...
public class F3ImageResize implements RequestHandler<HashMap<String, Object>, HashMap<String, Object>> {
    ...
    public HashMap<String, Object> handleRequest(HashMap<String, Object> request, Context context) {
        ...
        try {
            ...
            String base64Image = (String) request.get(IMAGE_FILE_KEY);
            ...
            try {
                ...
                response.put(ERROR_KEY, "Target width and height must be valid integers.");
                return response;
            }
            ...
            if (originalImage == null) {
                response.put(ERROR_KEY, "Invalid image format or decoding failed.");
                return response;
            }
            ...
            response.put(IMAGE_FILE_KEY, resizedImageBase64);
            ...
            e.printStackTrace();
            response.put(ERROR_KEY, "An error occurred: " + e.getMessage());
        }
